...
function rhsif_simple_instagram_feed_list($rhsif_entiven_link,$rhsif_entiven_text,$rhsif_entiven_likes,$rhsif_entiven_comments,$rhsif_entiven_image,$rhsif_entiven_time)
{
?>
<li id="rdh_sif_instafeed_id" class="rdh_sif_instafeed rhsif_lists">
						<a href="<?= $rhsif_entiven_link; ?>">
						<div class="rdh_sif_content-section_item">
							...
							<p class="rhsif_caption">
								<?php
									echo substr($rhsif_entiven_text, 0, 250);
								?>
							</p>
							</div>	
						</div>	
